...
"[project]/.next-internal/server/app/api/whatsapp/instances/[id]/qr/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/whatsapp/instances/[id]/qr/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const qrResponse = await evolutionClient.connectInstance(instance.name);
        ...
        const updatedInstance = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppInstance.findUnique({
            where: {
                id
            }
        });
...
async function POST(request, { params }) {
    try {
        ...
        const connectResponse = await evolutionClient.connectInstance(instance.name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bc7e5d34._.js.map