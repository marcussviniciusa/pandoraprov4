...
"[project]/.next-internal/server/app/api/admin/ai-config/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "1df3a810ef6c5cd48eb9fc7861ed31dd62627dfffa0d087d73308548480282dc",
    "copyEngine": true
};
...
"[project]/src/lib/ai/tool-parser.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ToolParser {
    static detectToolCalls(message, availableTools) {
        const toolCalls = [];
    ...
    static findBestTool(description, tools) {
        let bestMatch = null;
        let bestScore = 0;
    ...
    static findToolByContext(message, tools) {
    ...
    static calculateSimilarity(text1, text2) {
        // Normaliza textos
        const normalize = (text)=>text.toLowerCase().replace(/[^\w\s]/g, '').split(/\s+/).filter((word)=>word.length > 2) // Remove palavras muito pequenas
        ;
        ...
        const exactMatches = importantTerms.filter((term)=>text1.toLowerCase().includes(term) && text2.toLowerCase().includes(term));
    ...
    static analyzeMessage(message, availableTools) {
        const actionPatterns = [
            /(?:execute|executar|fazer|realizar|processar|consultar|buscar|verificar|gerar|criar)\s+(.+)/i,
            /(?:preciso que você|você pode|pode|você poderia|seria possível)\s+(.+)/i,
            /(?:solicito|peço|gostaria|necessito)\s+(.+)/i,
        ...
        const detectedPatterns = actionPatterns.map((pattern, index)=>message.match(pattern) ? `Pattern ${index + 1}` : null).filter(Boolean);
...
"[project]/src/lib/webhook/executor.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class WebhookExecutor {
    static async executeWebhook(tool, description, requestId, conversationId, agentId) {
        // Cria registro de execução
        const execution = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.create({
            data: {
                toolId: tool.id,
                requestId,
                description,
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post(tool.webhookUrl, payload, {
                timeout: 30000,
                headers: {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.update({
                where: {
                    id: execution.id
                },
                data: {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.update({
                ...
                data: {
                    ...
                    requestData: {
                        error: errorMessage,
                        errorCode: error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosError"] ? error.code || 'UNKNOWN' : 'UNKNOWN',
                        timestamp: new Date().toISOString()
                    }
                }
            });
    ...
    static async handleImmediateResponse(executionId, responseData, success) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.update({
            where: {
                id: executionId
            },
    ...
    static async handleCallback(requestId, success, result, error) {
        const execution = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.findUnique({
            where: {
                requestId
            },
            include: {
    ...
    static async getExecutionsWithTimeout(timeoutMinutes = 5) {
        const timeoutDate = new Date(Date.now() - timeoutMinutes * 60 * 1000);
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.findMany({
            where: {
                status: 'PENDING',
                startedAt: {
                    lt: timeoutDate
    ...
    static async markAsTimeout(executionIds) {
        if (executionIds.length === 0) return;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.updateMany({
            where: {
                id: {
                    in: executionIds
                }
    ...
    static async retryExecution(executionId) {
        ...
        return await this.executeWebhook(execution.tool, execution.description, newRequestId, execution.conversationId || undefined, execution.agentId || undefined);
    }
    // Estatísticas de execução
    static async getExecutionStats(officeId, days = 30) {
        const since = new Date(Date.now() - days * 24 * 60 * 60 * 1000);
        const stats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].toolExecution.groupBy({
            by: [
                'status'
            ],
            where: {
...
"[project]/src/lib/ai/multi-provider-manager.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "MultiProviderAIManager": (()=>MultiProviderAIManager),
    "multiProviderAIManager": (()=>multiProviderAIManager)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$anthropic$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@langchain/anthropic/index.js [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$anthropic$2f$dist$2f$chat_models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@langchain/anthropic/dist/chat_models.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/generated/prisma/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$tool$2d$parser$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai/tool-parser.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$webhook$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/webhook/executor.ts [app-route] (ecmascript)");
;
;
;
;
...
const MODEL_MAPPING = {
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4_1_MINI]: "gpt-4.1-mini",
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4O_MINI]: "gpt-4o-mini",
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4_5]: "gpt-4.5",
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GEMINI_2_5_PRO]: "gemini-2.5-pro",
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].CLAUDE_3_7]: "claude-3-5-sonnet-20241022",
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].CLAUDE_4]: "claude-4-latest"
};
class MultiProviderAIManager {
    agents = new Map() // eslint-disable-line @typescript-eslint/no-explicit-any
    ;
    providerConfigs = new Map() // officeId -> provider -> apiKey
    ;
    constructor(){
    ...
    async initializeAgents() {
        try {
            ...
            const providerConfigs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aIProviderConfig.findMany({
                where: {
                    isActive: true
                },
                include: {
            ...
            const agentConfigs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aiAgent.findMany({
                where: {
                    isActive: true
                },
                include: {
    ...
    createProviderLLM(provider, model, config) {
        const modelString = MODEL_MAPPING[model];
        try {
            switch(provider){
                case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI:
                ...
                case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].GOOGLE:
                    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$google$2d$genai$2f$dist$2f$chat_models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatGoogleGenerativeAI"]({
                        model: modelString,
                        temperature: config.temperature,
                        maxOutputTokens: config.maxTokens,
                        apiKey: config.apiKey
                    });
                case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].ANTHROPIC:
                    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$anthropic$2f$dist$2f$chat_models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatAnthropic"]({
                        model: modelString,
                        temperature: config.temperature,
                        maxTokens: config.maxTokens,
                        apiKey: config.apiKey
    ...
    async processMessage(agentId, message, context, conversationId) {
        try {
            // Buscar configuração do agente
            const agentConfig = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aiAgent.findUnique({
                where: {
                    id: agentId
                },
                include: {
            ...
            const availableTools = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tool.findMany({
                where: {
                    officeId: agentConfig.officeId,
                    isActive: true
                }
            });
            const toolCalls = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$tool$2d$parser$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ToolParser"].detectToolCalls(message, availableTools);
            let toolResults = [];
            let toolExecutions = [];
            ...
            for (const toolCall of toolCalls){
                try {
                    ...
                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$webhook$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WebhookExecutor"].executeWebhook(toolCall.tool, toolCall.description, toolCall.requestId, conversationId, agentId);
            ...
            const conversationHistory = context.conversationHistory.slice(-10) // Últimas 10 mensagens
            .map((msg)=>`${msg.isFromClient ? 'Cliente' : 'Atendente'}: ${msg.content}`).join('\n');
            // Criar prompt contextualizado incluindo execução de tools
            let systemPrompt = this.buildSystemPrompt(agentConfig, context, conversationHistory);
            ...
            const transferAnalysis = await this.analyzeTransferNeed(agentConfig, message, responseText);
            // Sugerir tags baseadas no conteúdo
            const suggestedTags = await this.suggestTags(agentConfig.officeId, message, responseText);
            return {
            ...
            return {
                ...
                shouldTransfer: true,
                suggestedTags: [],
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4O_MINI // fallback
            };
        }
    }
    buildSystemPrompt(agentConfig, context, conversationHistory) {
...
RESPONDA APENAS COM O TEXTO DA RESPOSTA AO CLIENTE, SEM METADADOS OU INSTRUÇÕES.`;
    ...
    async analyzeTransferNeed(agentConfig, clientMessage, _agentResponse// eslint-disable-line @typescript-eslint/no-unused-vars
    ) {
        ...
        const keywords = {
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentType"].BPC_LOAS]: [
                'bpc',
                'loas',
            ...
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentType"].PREVIDENCIARIO]: [
                'aposentadoria',
                'inss',
                'previdência',
                'benefício',
            ...
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentType"].TRABALHISTA]: [
                'trabalho',
                'emprego',
                'demissão',
                'rescisão',
        ...
        for (const [agentType, keywordList] of Object.entries(keywords)){
            if (agentType !== agentConfig.type) {
                const hasKeywords = keywordList.some((keyword)=>message.includes(keyword));
                if (hasKeywords) {
                    return {
                        shouldTransfer: true,
    ...
    async suggestTags(officeId, clientMessage, _agentResponse// eslint-disable-line @typescript-eslint/no-unused-vars
    ) {
        try {
            // Buscar tags disponíveis para o escritório
            const availableTags = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tag.findMany({
                where: {
                    officeId,
                    isActive: true
                }
    ...
    async getAvailableAgents(officeId) {
        try {
            const agents = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aiAgent.findMany({
                where: {
                    officeId,
                    isActive: true
                },
    ...
    async getAvailableModels() {
        return [
            {
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4_1_MINI,
                displayName: "GPT-4.1 Mini",
                description: "Modelo eficiente e rápido da OpenAI"
            },
            {
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4O_MINI,
                displayName: "GPT-4o Mini",
                description: "Modelo otimizado da OpenAI"
            },
            {
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4_5,
                displayName: "GPT-4.5",
                description: "Modelo mais avançado da OpenAI"
            },
            {
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].GOOGLE,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GEMINI_2_5_PRO,
                displayName: "Gemini 2.5 Pro",
                description: "Modelo avançado do Google"
            },
            {
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].ANTHROPIC,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].CLAUDE_3_7,
                displayName: "Claude 3.7",
                description: "Modelo analítico da Anthropic"
            },
            {
                provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].ANTHROPIC,
                model: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].CLAUDE_4,
    ...
    async checkProviderHealth(officeId) {
        const health = {
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI]: false,
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].GOOGLE]: false,
            [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].ANTHROPIC]: false
        };
        try {
            ...
            for (const [provider, apiKey] of configs.entries()){
                try {
                    const testLLM = this.createProviderLLM(provider, provider === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].OPENAI ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GPT_4O_MINI : provider === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].GOOGLE ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].GEMINI_2_5_PRO : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModel"].CLAUDE_3_7, {
                        temperature: 0,
                        maxTokens: 10,
                        apiKey
                    });
                    if (testLLM) {
                        await testLLM.invoke([
                            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$messages$2f$human$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HumanMessage"]("test")
                        ]);
...
const multiProviderAIManager = new MultiProviderAIManager();
}}),
"[project]/src/app/api/admin/ai-config/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/generated/prisma/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$multi$2d$provider$2d$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai/multi-provider-manager.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(request) {
    try {
        ...
        const availableModels = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$multi$2d$provider$2d$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["multiProviderAIManager"].getAvailableModels();
        // Verificar saúde dos providers
        const providerHealth = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$multi$2d$provider$2d$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["multiProviderAIManager"].checkProviderHealth(session.user.officeId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                providerConfigs,
...
async function POST(request) {
    try {
        ...
        if (!Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"]).includes(provider)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const config = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aIProviderConfig.upsert({
            where: {
                officeId_provider: {
                    officeId: session.user.officeId,
                    provider
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$multi$2d$provider$2d$manager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["multiProviderAIManager"].refreshAgents();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function PUT(request) {
    try {
        ...
        const existingAgent = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aiAgent.findFirst({
            where: {
                id: agentId,
                officeId: session.user.officeId
            }
        ...
        const providerConfig = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aIProviderConfig.findFirst({
            where: {
                officeId: session.user.officeId,
                provider,
                isActive: true
        ...
        // Atualizar agente
        const updatedAgent = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aiAgent.update({
            where: {
                id: agentId
            },
            data: {
...
async function DELETE(request) {
    try {
        ...
        const agentsUsingProvider = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aiAgent.findMany({
            where: {
                officeId: session.user.officeId,
                provider,
                isActive: true
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].aIProviderConfig.deleteMany({
            where: {
                officeId: session.user.officeId,
                provider
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9a6ad0e._.js.map