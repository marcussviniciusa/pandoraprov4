...
"[project]/.next-internal/server/app/api/whatsapp/instances/[id]/status/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/whatsapp/instances/[id]/status/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (statusResponse.success && statusResponse.data) {
            ...
            if (newStatus !== instance.status) {
                ...
                const updatedInstance = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppInstance.update({
                    where: {
                        id
                    },
                    data: {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedInstance);
            }
        } else {
            ...
            if (instance.status !== 'DISCONNECTED') {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppInstance.update({
                    where: {
                        id
                    },
                    data: {
        ...
        const updatedInstance = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppInstance.findFirst({
            where: {
                id,
                officeId: session.user.officeId
            },
...
async function POST(request, { params }) {
    try {
        ...
        if (!actionResponse || !actionResponse.success) {
            ...
            if (actionResponse?.error?.message?.includes('is not connected') || actionResponse?.error?.message?.includes('not connected')) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__afb9639c._.js.map