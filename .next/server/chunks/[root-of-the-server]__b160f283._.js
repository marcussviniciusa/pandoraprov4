...
"[project]/.next-internal/server/app/api/whatsapp/conversations/[id]/mark-read/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/whatsapp/conversations/[id]/mark-read/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const conversation = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppConversation.findFirst({
            where: {
                id,
                instance: {
        ...
        if (messageId) {
            const message = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppMessage.findFirst({
                where: {
                    id: messageId,
                    conversationId: id,
            ...
            if (conversation.instance.status === 'CONNECTED') {
                try {
                    ...
                    await evolutionClient.markMessageAsRead(conversation.instance.name, conversation.remoteJid, message.messageId);
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppMessage.update({
                where: {
                    id: messageId
                },
                data: {
            ...
            const unreadMessages = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppMessage.findMany({
                where: {
                    conversationId: id,
                    fromMe: false,
                    status: {
            ...
            if (conversation.instance.status === 'CONNECTED' && unreadMessages.length > 0) {
                try {
                    ...
                    await evolutionClient.markMessageAsRead(conversation.instance.name, conversation.remoteJid, latestMessage.messageId);
                } catch (evolutionError) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].whatsAppMessage.updateMany({
                where: {
                    conversationId: id,
                    fromMe: false,
                    status: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b160f283._.js.map